...
my $metaphlan1="/allwegene3/work/fanyucai/software/metaphlan/metaphlan_v1/";
my $python="python";
my $shuffle2fq="/allwegene3/work/fanyucai/metagenomics/sub/shuffleSequences_fastq.pl";
my $db="/allwegene3/work/fanyucai/software/metaphlan/metaphlan2/db_v20/mpa_v20_m200";
my $graphlan="/allwegene3/work/fanyucai/software/graphlan/";
my $krona="/allwegene3/work/fanyucai/software/KronaTools/KronaTools-2.7/bin";
...
my $bam_script="/allwegene3/work/fanyucai/script/bam_statistics.pl";
GetOptions(
    "pe1:s{1,}"=>\@pe1,
    "pe2:s{1,}"=>\@pe2,
    "o:s"=>\$outdir,
...
sub qsub()
{
    ...
    $queue||="big.q";
    $ass_maxproc||=5;
    my $cmd = "perl /allwegene3/work/jianghao/qsub_sge.pl --maxproc $ass_maxproc --queue $queue --resource vf=15G --reqsub $shfile --independent" ;
    my $flag=system($cmd);
    if($flag !=0)
    {
